...
import static com.example.webbasestarttask.util.constant.PagePath.PASSWORD_CHANGE_SUCCESS;

public class ViewChangePasswordSuccessCommand implements Command {
    @Override
    public Router execute(HttpServletRequest request, HttpServletResponse response) throws CommandException, ServletException, IOException {
        return new Router(PASSWORD_CHANGE_SUCCESS);
    }
}
